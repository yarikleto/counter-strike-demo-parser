...
export const CMsgCVars_CVar = {
  encode(message: CMsgCVars_CVar, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.dictionaryName !== undefined && message.dictionaryName !== 0) {
...
export const CNETMsgFile = {
  encode(message: CNETMsgFile, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.transferId !== undefined && message.transferId !== 0) {
      writer.uint32(8).int32(message.transferId);
    }
    if (message.fileName !== undefined && message.fileName !== "") {
      writer.uint32(18).string(message.fileName);
    }
    if (message.isReplayDemoFile !== undefined && message.isReplayDemoFile !== false) {
      writer.uint32(24).bool(message.isReplayDemoFile);
    }
    if (message.deny !== undefined && message.deny !== false) {
      writer.uint32(32).bool(message.deny);
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CNETMsgFile {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CNETMsgPlayerAvatarData = {
  encode(message: CNETMsgPlayerAvatarData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.accountid !== undefined && message.accountid !== 0) {
      writer.uint32(8).uint32(message.accountid);
    }
    if (message.rgb !== undefined && message.rgb.length !== 0) {
      writer.uint32(18).bytes(message.rgb);
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CNETMsgPlayerAvatarData {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CCLCMsgMove = {
  encode(message: CCLCMsgMove, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.numBackupCommands !== undefined && message.numBackupCommands !== 0) {
      writer.uint32(8).uint32(message.numBackupCommands);
    }
    if (message.numNewCommands !== undefined && message.numNewCommands !== 0) {
...
export const CCLCMsgVoiceData = {
  encode(message: CCLCMsgVoiceData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.xuid !== undefined && message.xuid !== 0n) {
      if (BigInt.asUintN(64, message.xuid) !== message.xuid) {
        throw new globalThis.Error("value provided for field message.xuid of type fixed64 too large");
      }
      writer.uint32(17).fixed64(message.xuid.toString());
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          message.xuid = longToBigint(reader.fixed64() as Long);
          continue;
        case 3:
          if (tag !== 24) {
            break;
  ...
  fromJSON(object: any): CCLCMsgVoiceData {
    return {
      data: isSet(object.data) ? bytesFromBase64(object.data) : new Uint8Array(0),
      xuid: isSet(object.xuid) ? BigInt(object.xuid) : 0n,
      format: isSet(object.format) ? voiceDataFormatTFromJSON(object.format) : 1,
  ...
  toJSON(message: CCLCMsgVoiceData): unknown {
    ...
    if (message.xuid !== undefined && message.xuid !== 0n) {
      obj.xuid = message.xuid.toString();
    }
    if (message.format !== undefined && message.format !== 1) {
  ...
  fromPartial<I extends Exact<DeepPartial<CCLCMsgVoiceData>, I>>(object: I): CCLCMsgVoiceData {
    const message = createBaseCCLCMsgVoiceData();
    message.data = object.data ?? new Uint8Array(0);
    message.xuid = object.xuid ?? 0n;
    message.format = object.format ?? 1;
...
export const CCLCMsgFileCRCCheck = {
  encode(message: CCLCMsgFileCRCCheck, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.fileFraction !== undefined && message.fileFraction !== 0) {
      writer.uint32(40).int32(message.fileFraction);
    }
    if (message.md5 !== undefined && message.md5.length !== 0) {
      writer.uint32(50).bytes(message.md5);
    }
    if (message.crc !== undefined && message.crc !== 0) {
      writer.uint32(56).uint32(message.crc);
    }
    if (message.fileHashType !== undefined && message.fileHashType !== 0) {
    ...
    if (message.packFileId !== undefined && message.packFileId !== 0) {
      writer.uint32(80).int32(message.packFileId);
    }
    if (message.packFileNumber !== undefined && message.packFileNumber !== 0) {
...
export const CCLCMsgCmdKeyValues = {
  encode(message: CCLCMsgCmdKeyValues, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.keyvalues !== undefined && message.keyvalues.length !== 0) {
...
export const CSVCMsgServerInfo = {
  encode(message: CSVCMsgServerInfo, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.isOfficialValveServer !== undefined && message.isOfficialValveServer !== false) {
    ...
    if (message.isRedirectingToProxyRelay !== undefined && message.isRedirectingToProxyRelay !== false) {
    ...
    if (message.mapCrc !== undefined && message.mapCrc !== 0) {
      writer.uint32(69).fixed32(message.mapCrc);
    }
    if (message.clientCrc !== undefined && message.clientCrc !== 0) {
      writer.uint32(77).fixed32(message.clientCrc);
    }
    if (message.stringTableCrc !== undefined && message.stringTableCrc !== 0) {
    ...
    if (message.mapGroupName !== undefined && message.mapGroupName !== "") {
    ...
    if (message.publicIp !== undefined && message.publicIp !== 0) {
      writer.uint32(160).uint32(message.publicIp);
    }
    if (message.ugcMapId !== undefined && message.ugcMapId !== 0n) {
      if (BigInt.asUintN(64, message.ugcMapId) !== message.ugcMapId) {
        throw new globalThis.Error("value provided for field message.ugcMapId of type uint64 too large");
      }
      writer.uint32(176).uint64(message.ugcMapId.toString());
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 22:
          ...
          message.ugcMapId = longToBigint(reader.uint64() as Long);
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
        break;
  ...
  fromJSON(object: any): CSVCMsgServerInfo {
    return {
      ...
      ugcMapId: isSet(object.ugcMapId) ? BigInt(object.ugcMapId) : 0n,
    };
  },
  ...
  toJSON(message: CSVCMsgServerInfo): unknown {
    ...
    if (message.ugcMapId !== undefined && message.ugcMapId !== 0n) {
      obj.ugcMapId = message.ugcMapId.toString();
    }
    return obj;
  },
  ...
  fromPartial<I extends Exact<DeepPartial<CSVCMsgServerInfo>, I>>(object: I): CSVCMsgServerInfo {
    ...
    message.ugcMapId = object.ugcMapId ?? 0n;
    return message;
  },
};
...
export const CSVCMsgClassInfo_classT = {
  encode(message: CSVCMsgClassInfo_classT, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.dataTableName !== undefined && message.dataTableName !== "") {
...
export const CSVCMsgVoiceData = {
  encode(message: CSVCMsgVoiceData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.client !== undefined && message.client !== 0) {
    ...
    if (message.xuid !== undefined && message.xuid !== 0n) {
      ...
      writer.uint32(25).fixed64(message.xuid.toString());
    }
    ...
    if (message.caster !== undefined && message.caster !== false) {
...
export const CSVCMsgPaintmapData = {
  encode(message: CSVCMsgPaintmapData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.paintmap !== undefined && message.paintmap.length !== 0) {
      writer.uint32(10).bytes(message.paintmap);
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CSVCMsgPaintmapData {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CSVCMsgGameEvent_keyT = {
  encode(message: CSVCMsgGameEvent_keyT, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.valUint64 !== undefined && message.valUint64 !== 0n) {
      if (BigInt.asUintN(64, message.valUint64) !== message.valUint64) {
        throw new globalThis.Error("value provided for field message.valUint64 of type uint64 too large");
      }
      writer.uint32(64).uint64(message.valUint64.toString());
    }
    if (message.valWstring !== undefined && message.valWstring.length !== 0) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 8:
          ...
          message.valUint64 = longToBigint(reader.uint64() as Long);
          continue;
        case 9:
          if (tag !== 74) {
            break;
  ...
  fromJSON(object: any): CSVCMsgGameEvent_keyT {
    return {
      ...
      valUint64: isSet(object.valUint64) ? BigInt(object.valUint64) : 0n,
  ...
  toJSON(message: CSVCMsgGameEvent_keyT): unknown {
    ...
    if (message.valUint64 !== undefined && message.valUint64 !== 0n) {
      obj.valUint64 = message.valUint64.toString();
    }
    if (message.valWstring !== undefined && message.valWstring.length !== 0) {
  ...
  fromPartial<I extends Exact<DeepPartial<CSVCMsgGameEvent_keyT>, I>>(object: I): CSVCMsgGameEvent_keyT {
    ...
    message.valUint64 = object.valUint64 ?? 0n;
...
export const CSVCMsgPacketEntities = {
  encode(message: CSVCMsgPacketEntities, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.isDelta !== undefined && message.isDelta !== false) {
...
export const CSVCMsgEntityMsg = {
  encode(message: CSVCMsgEntityMsg, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.entData !== undefined && message.entData.length !== 0) {
      writer.uint32(26).bytes(message.entData);
    }
    return writer;
  },

  decode(input: _m0.Reader | Uint8Array, length?: number): CSVCMsgEntityMsg {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CSVCMsgEncryptedData = {
  encode(message: CSVCMsgEncryptedData, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.encrypted !== undefined && message.encrypted.length !== 0) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): CSVCMsgEncryptedData {
    const reader = input instanceof _m0.Reader ? input : _m0.Reader.create(input);
    let end = length === undefined ? reader.len : reader.pos + length;
...
export const CSVCMsgHltvReplay = {
  encode(message: CSVCMsgHltvReplay, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.primaryTarget !== undefined && message.primaryTarget !== 0) {
...
export const CCLCMsgHltvReplay = {
  encode(message: CCLCMsgHltvReplay, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.primaryTargetEntIndex !== undefined && message.primaryTargetEntIndex !== 0) {
  ...
  fromJSON(object: any): CCLCMsgHltvReplay {
    return {
      ...
      primaryTargetEntIndex: isSet(object.primaryTargetEntIndex) ? globalThis.Number(object.primaryTargetEntIndex) : 0,
